...
double (*WELLRNG44497av1)(void);

void InitWELLRNG44497av1(unsigned int *init ){
   int j;
   state_i=0;
   WELLRNG44497av1 = case_1;
   for(j=0;j<R;j++)
      STATE[j]=init[j];
}
