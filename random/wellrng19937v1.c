...
static double case_6 (void);
       double (*WELLRNG19937av1) (void);

static unsigned int y;

void InitWELLRNG19937av1 (unsigned int *init){
   int j;
   state_i = 0;
   WELLRNG19937av1 = case_1;
   for (j = 0; j < R; j++)
     STATE[j] = init[j];
}
