...
int main(int argc, char* argv[])
{
	...
	fprintf(target_op_decl_file, "// %s - Declarations for the '%s' module. Include in your module header file.\n\n", target_op_decl_name, target_stem);
	fprintf(target_op_data_file, "// %s - Data (machine code) for the '%s' module. Include in your module source file.\n\n", target_op_data_name, target_stem);
	fprintf(target_op_decl_file, "// %s - Switch entries for the '%s' module. Include in your sm_op() switch statement in your module source file.\n\n", target_op_impl_name, target_stem);
