...
#define SM_CMP_RC_OK        0 // Success.
#define SM_CMP_RC_SIZE      1 // Output buffer too small.
#define SM_CMP_RC_CORRUPT   2 // Invalid data for decompression.
#define SM_CMP_RC_ARGUMENTS 3 // Arguments invalid.
