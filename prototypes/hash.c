...
uint64_t __stdcall sec_hashing_city_bytes_64(const void *restrict p, size_t n)
{
...
uint64_t __stdcall sec_hashing_murmur_bytes_64(const void *restrict p, size_t n)
{
...
uint32_t __stdcall sec_hashing_murmur_bytes_32(const void *restrict p, register size_t n)
{
